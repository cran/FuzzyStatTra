...
# Construction of the matrix F with n x 4:
       ...
       spr1=1/(mid1^2+1)^2+0.1*cbind(rchisq(n,1)) # spr1
       lspr0=1/(mid1^2+1)^2+0.1*cbind(rchisq(n,1)) # lspr0 (=inf1-inf0)
       rspr0=1/(mid1^2+1)^2+0.1*cbind(rchisq(n,1)) #rspr0 (=sup0-sup1)
